...
Most habit trackers can express "did I do this today" and nothing else. timeslife is built
...
accounts, no database to run. Google Calendar is a peer store: timeslife reads and writes it,
